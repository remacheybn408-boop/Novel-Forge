# Novel Pipeline - Write Engine v0.5.5
...
├── novel.py                         ← [v0.5.5] 统一入口
├── version.py                       ← [v0.5.5] 版本号统一源
├── VERSION                          ← 当前版本号
├── templates/                       ← [v0.5.5] 题材/声纹/梗模板
│   ├── genres/                      ← 5 种题材模板
...
- [v0.5.5 Stable & Easy Mode 详解](docs/V050_STABLE_EASY_MODE.md) ← 必读

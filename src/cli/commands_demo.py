...
def cmd_demo():
    ...
    db_init_result = _sp.run(
        ...
        cwd=str(PROJECT_ROOT), timeout=60, capture_output=True, **_utf8_subprocess_options()
    )
    ...
    pre_result = _sp.run(
        ...
        cwd=str(PROJECT_ROOT), timeout=180, capture_output=True, **_utf8_subprocess_options()
    )
    ...
    post_result = _sp.run(
        ...
        cwd=str(PROJECT_ROOT), timeout=300, capture_output=True, **_utf8_subprocess_options()
    )

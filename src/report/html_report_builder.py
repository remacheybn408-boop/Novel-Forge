...
def get_voice_pack_status() -> dict:
    """Check voice_packs/ directory status."""
...
def build_html(
    ...
    if guard_summary:
        ...
        <div class="section">
            ...
            <div class="empty-state">
                ...
                <p>暂无门禁数据。请运行 <code>python novel.py review &lt;N&gt;</code> 生成门禁报告。</p>
            </div>
        </div>"""
    ...
    if voice_status["exists"]:
        ...
        <div class="section">
            ...
            <div class="empty-state">
                <div class="empty-icon">&#128227;</div>
                <p>voice_packs/ 目录未找到。请运行 <code>install.bat</code> 初始化声纹包。</p>
            </div>
        </div>"""
...
def main():
    ...
    print(f"Generating HTML report for `{slug}`...")

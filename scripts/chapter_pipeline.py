...
def main():
    ...
    if args.action == "pre":
        ...
        from src.guards.canon_evidence_guard import run_canon_evidence_check as run_ceg
        ...
        from src.guards.scene_delta_guard import run_scene_delta_check as run_sdg
        ...
        from src.guards.padding_guard import run_padding_check as run_pg
        ...
        try:
            ...
            try:
                ...
                genre = args.genre or cfg.get("default_genre", "default")

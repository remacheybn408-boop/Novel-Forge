#!/usr/bin/env python3
"""
novel.py — Novel Pipeline Write Engine CLI v0.5.5
...
Usage:
  ...
  python novel.py check <file>        Run v0.5.5 guards on a chapter file
"""
...
def cmd_check(file_path: str):
    """Run v0.5.5 guards on a chapter file."""
    fp = Path(file_path)
    if not fp.exists():
...
def main():
    ...
    # check
    p_check = sub.add_parser("check", help="Run v0.5.5 guards on a chapter file")
